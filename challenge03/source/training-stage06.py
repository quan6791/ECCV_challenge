...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul  2 15:41:30 2018
...
fp = (sorted(glob('../data_set/training_output_05/*.jpg')), sorted(glob('../data_set/training_ground-truth/*.jpg')))
...
#     print (y.shape ,y_hat.shape)
    ...
    if (i + 1) % frequency == 0:
        ...
        save_npz('../model_step06.npz', model.copy().to_cpu())
